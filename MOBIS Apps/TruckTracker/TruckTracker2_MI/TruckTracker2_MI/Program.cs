...
public class Tracker : Form
{
    ...
    public Tracker()
    {
        ...
        // webBrowser2.CanGoBackChanged +=
        //     new EventHandler(webBrowser1_CanGoBackChanged);
        // webBrowser1.CanGoForwardChanged +=
        //     new EventHandler(webBrowser1_CanGoForwardChanged);
        // webBrowser2.CanGoForwardChanged +=
        //     new EventHandler(webBrowser1_CanGoForwardChanged);
        // webBrowser1.DocumentTitleChanged +=
        //     new EventHandler(webBrowser1_DocumentTitleChanged);
        // webBrowser2.DocumentTitleChanged +=
        //     new EventHandler(webBrowser1_DocumentTitleChanged);
        // webBrowser1.StatusTextChanged +=
        //     new EventHandler(webBrowser1_StatusTextChanged);
        // webBrowser2.StatusTextChanged +=
        //     new EventHandler(webBrowser1_StatusTextChanged);

        // Load the user's home page.
        //webBrowser1.GoHome();

        webBrowser1.Navigate("track.safetytrack.net/VehicleTracker/VehicleTracker.aspx?appid=87");
        webBrowser2.Navigate("track.safetytrack.net/VehicleTracker/VehicleTracker.aspx?appid=87");
    }
    ...
    // private void webBrowser2_Navigated(object sender,
    //     WebBrowserNavigatedEventArgs e)
    // {
    ...
    private void InitializeForm()
    {
        ...
        // toolStripTextBox1.Size = new System.Drawing.Size((width-150), 25);
        ...
        webBrowser2.Dock = DockStyle.Right;
        // webBrowser1.Navigated +=
        //     new WebBrowserNavigatedEventHandler(webBrowser1_Navigated);
        // webBrowser2.Navigated +=
        //     new WebBrowserNavigatedEventHandler(webBrowser2_Navigated);

        Controls.AddRange(new Control[] {
            webBrowser1, webBrowser2});/*, toolStrip2});/*, toolStrip1, 
